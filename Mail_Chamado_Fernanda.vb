...
' ----------------------------------------------------------------------
    ...
    txt_defeito = Worksheets(1).Cells(addr_lin, 8)
    txt_solucao = Worksheets(1).Cells(addr_lin, 9)
    
   ' Alimenta variaveis de texto com valores sring
    campo_assunto = "Reparo de equipamento com defeito -  Código da loja: " & chamad_cod_loja
    
    Saud = "Olá Fernanda"
    Solic = "Peço a gentileza de solicitar reparo para o(s) seguinte(s) equipamento(s): "
    Encer = "Fico no aguardo de retorno e agradeço pela atenção dispensada."
    Categ00 = "*** Categorização ***"
    Categ01 = "Manifestação = Reclamação"
    Categ02 = "Categoria = Equipamento"
    Categ03 = "Assunto = Computador"
    Categ04 = "Sub Assunto 1 = Migração"
