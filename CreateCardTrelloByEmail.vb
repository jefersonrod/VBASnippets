...
Dim colAcao As Integer
Dim colSugestao As Integer
Dim colResponsavel As Integer
Dim colDataAcao As Integer
...
Else
    ...
    acao = Worksheets(plan).Cells(linhaAtual, colAcao)
    sugestao = Worksheets(plan).Cells(linhaAtual, colSugestao)
    responsavel = Worksheets(plan).Cells(linhaAtual, colResponsavel)
    dataAcao = Worksheets(plan).Cells(linhaAtual, colDataAcao)
    'MsgBox (linhaAtual)
End If
...
'Feed email fields
assunto = "Trat.Lote2 lj " + loja + " - " + acao + " " + tag
corpo = responsavel + br + _
        "Responsável: " + responsavel + br + _
        "Loja: " + loja + br + _
        "CP: " + cp + br + _
        "Sugestão: " + sugestao + br + _
        "Data Ação: " + dataAcao + br + br
